# -*- coding: utf-8 -*-
"""
Loại tài sản đảm bảo (collateral type) — master data.

Master nhỏ, seed sẵn các loại TS đảm bảo phổ biến của doanh nghiệp xây
...
class ReLoanCollateralType(models.Model):
    ...
    _description = 'Loại tài sản đảm bảo'
