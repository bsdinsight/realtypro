...
- ✅ Cần rút 1 đợt cụ thể (vd 10 tỷ cho HĐ thi công móng dự án Đà Lạt)
...
| Mục đích sử dụng vốn | Auto-load từ Hạn mức, có thể override | `Vốn lưu động — Thi công móng dự án Đà Lạt` |
...
Đà Lạt**. Cần vay **10 tỷ** từ Vietcombank để thanh toán nhà thầu thi
công móng cọc khu A.
...
## 9.8c. Giấy báo Nợ/Có — điều chỉnh lãi hồi tố
...
- **Giấy báo Nợ** (truy thu) — khách phải trả thêm
- **Giấy báo Có** (truy hoàn) — khách được giảm trừ

Ghi nhận tại menu **Quản lý Vay → Giấy báo Nợ/Có**: chọn KW + số tiền
(theo chứng từ NH) + kỳ áp dụng (mặc định kỳ chưa thanh toán sớm
nhất) → **"Áp dụng vào kỳ"** → tạo dòng **"Điều chỉnh"** trong lịch
lãi (tô đỏ, ref số giấy báo), tăng/giảm số phải trả kỳ đó.
...
Cột cảnh báo **"⚠ Cần giấy báo"**: KW có kỳ đã trả sau ngày hiệu lực
— phần đó chờ Giấy báo Nợ/Có của NH (9.8c), wizard không tính lại.
